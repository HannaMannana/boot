...
public class PersonServiceAspect {
    ...
    @Pointcut(value = "execution(* com.clever.boot.service.PersonService.*(..))")
    ...
    public void afterThrowingPersonService(Throwable exception) {
        log.info("afterThrowingPersonService: exception message {}",exception.getMessage());
    }
}
