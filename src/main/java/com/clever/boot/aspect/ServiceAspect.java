...
public class ServiceAspect {
    ...
    @Pointcut(value = "execution(* com.clever.boot.service.HouseService.*(..))")
    ...
    public void afterThrowingHouseService(Throwable exception) {
        log.info("afterThrowingHouseService: exception message {}",exception.getMessage());
    }
}
